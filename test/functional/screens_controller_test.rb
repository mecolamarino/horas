...
class ScreensControllerTest < ActionController::TestCase
  ...
  test "should create screen" do
    assert_difference('Screen.count') do
      post :create, screen: { mark_id: @screen.mark_id, modelo: @screen.modelo, size_id: @screen.size_id, type_id: @screen.type_id }
    end
  ...
  test "should update screen" do
    put :update, id: @screen, screen: { mark_id: @screen.mark_id, modelo: @screen.modelo, size_id: @screen.size_id, type_id: @screen.type_id }
    assert_redirected_to screen_path(assigns(:screen))
  end
