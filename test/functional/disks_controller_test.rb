...
class DisksControllerTest < ActionController::TestCase
  ...
  test "should create disk" do
    assert_difference('Disk.count') do
      post :create, disk: { cache: @disk.cache, capacidad: @disk.capacidad, mark_id: @disk.mark_id, modelo: @disk.modelo }
    end
  ...
  test "should update disk" do
    put :update, id: @disk, disk: { cache: @disk.cache, capacidad: @disk.capacidad, mark_id: @disk.mark_id, modelo: @disk.modelo }
    assert_redirected_to disk_path(assigns(:disk))
  end
